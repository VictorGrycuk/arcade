...
export class configuration {
    ...
    public parameters:{ [index:string] : {name: string, value: string} } = {
        inputRootFolder: { name: 'inputRootFolder', value: '' },
        inputFilesName: { name: 'inputFilesName', value: '' },
        nugetPackageName: { name: 'nugetPackageName', value: '' },
        packageSubFolder: { name: 'packageSubFolder', value: '' },
        packageVersion: { name: 'packageVersion', value: '' },
